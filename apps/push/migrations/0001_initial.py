...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Device'
        db.create_table(u'push_device', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='devices', to=orm['users.User'])),
        ...
        db.send_create_signal(u'push', ['Device'])

        # Adding unique constraint on 'Device', fields ['token', 'type']
        db.create_unique(u'push_device', ['token', 'type'])

        # Adding model 'Chunk'
        db.create_table(u'push_chunk', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('data', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('expiration', self.gf('django.db.models.fields.DateTimeField')()),
            ('devices_number', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'push', ['Chunk'])

        # Adding M2M table for field devices on 'Chunk'
        m2m_table_name = db.shorten_name(u'push_chunk_devices')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('chunk', models.ForeignKey(orm[u'push.chunk'], null=False)),
            ('device', models.ForeignKey(orm[u'push.device'], null=False))
        ))
        db.create_unique(m2m_table_name, ['chunk_id', 'device_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Device', fields ['token', 'type']
        db.delete_unique(u'push_device', ['token', 'type'])

        # Deleting model 'Device'
        db.delete_table(u'push_device')

        # Deleting model 'Chunk'
        db.delete_table(u'push_chunk')

        # Removing M2M table for field devices on 'Chunk'
        db.delete_table(db.shorten_name(u'push_chunk_devices'))
    ...
    models = {
        ...
        u'push.chunk': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'Chunk'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'data': ('django.db.models.fields.TextField', [], {}),
            'devices': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'chunks'", 'symmetrical': 'False', 'to': u"orm['push.Device']"}),
            'devices_number': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'expiration': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'push.device': {
            'Meta': {'unique_together': "(('token', 'type'),)", 'object_name': 'Device'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'devices'", 'to': u"orm['users.User']"})
        },
        u'users.user': {
