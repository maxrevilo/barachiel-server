...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'likes_like', (
            ...
            ('liker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes_from', to=orm['users.User'])),
            ('liked', self.gf('django.db.models.fields.related.ForeignKey')(related_name='likes_to', to=orm['users.User'])),
        ...
        # Adding unique constraint on 'Like', fields ['liker', 'liked']
        db.create_unique(u'likes_like', ['liker_id', 'liked_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Like', fields ['liker', 'liked']
        db.delete_unique(u'likes_like', ['liker_id', 'liked_id'])
