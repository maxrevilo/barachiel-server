...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'debug_gps_position', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='positions', to=orm['users.User'])),
            ('lat', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('lon', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('alt', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('speed', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('heading', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('accuracy', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('alt_accuracy', self.gf('django.db.models.fields.FloatField')(default=0, null=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('device_type', self.gf('django.db.models.fields.CharField')(default='??', max_length=2)),
            ('app_version', self.gf('django.db.models.fields.CharField')(max_length=16, null=True)),
            ('extra', self.gf('django.db.models.fields.TextField')(default='', null=True)),
            ('_created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'debug_gps', ['Position'])


    def backwards(self, orm):
        # Deleting model 'Position'
        db.delete_table(u'debug_gps_position')


    models = {
        u'debug_gps.position': {
            'Meta': {'ordering': "['-_created_at']", 'object_name': 'Position'},
            '_created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'accuracy': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'alt': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'alt_accuracy': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'app_version': ('django.db.models.fields.CharField', [], {'max_length': '16', 'null': 'True'}),
            'device_type': ('django.db.models.fields.CharField', [], {'default': "'??'", 'max_length': '2'}),
            'extra': ('django.db.models.fields.TextField', [], {'default': "''", 'null': 'True'}),
            'heading': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lat': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'lon': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'speed': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'positions'", 'to': u"orm['users.User']"})
        },
        u'likes.like': {
